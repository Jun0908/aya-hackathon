...
export const character: Character = {
  ...
  messageExamples: [
    [
      ...
      name: 'user',
      content: {
        text: 'この proof を検証して。結果だけ返して',
      },
     },
     {
      name: 'Eliza',
      content: {
        text: `zkTemp.verify_temp_local {"proof":{"pi_a":["1855767114...","2176010888...","1"],"pi_b":[["12248259...","13673237..."],["12671979...","18586917..."],["1","0"]],"pi_c":["21263254...","32756189...","1"]},"publicSignals":["1"]}`,
      },
      },
      {
        name: '{{name1}}',
